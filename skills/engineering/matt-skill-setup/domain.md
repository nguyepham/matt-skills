...
missing files => proceed silently. skip missing flags. skip upfront creation. `/matt-domain-modeling` skill creates lazily on term/decision resolution.
...
missing concept => reconsider invented language or note gap for `/matt-domain-modeling`.
