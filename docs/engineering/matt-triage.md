...
| A rough idea of your own, nothing written down | [matt-grill-with-docs](../../skills/engineering/matt-grill-with-docs/SKILL.md) |
| A settled conversation to turn into a [spec](https://www.aihero.dev/ai-coding-dictionary/spec) | [matt-to-spec](../../skills/engineering/matt-to-spec/SKILL.md) |
| A spec to split into agent-ready tickets | [matt-to-tickets](../../skills/engineering/matt-to-tickets/SKILL.md) |
