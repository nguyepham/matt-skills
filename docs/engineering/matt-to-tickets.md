...
Upstream is [matt-to-spec](../../skills/engineering/matt-to-spec/SKILL.md), which hands it a settled spec to slice against; keep both in one unbroken context window. Downstream is [implement](../../skills/engineering/matt-implement/SKILL.md), which builds one ticket per fresh session, driving [tdd](../../skills/engineering/matt-tdd/SKILL.md) for the tests and closing with [matt-code-review](../../skills/engineering/matt-code-review/SKILL.md). When you're unsure which skill or flow fits, [matt-ask-matt](../../skills/engineering/matt-ask/SKILL.md) routes you.
