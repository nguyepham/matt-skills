...
`matt-grilling` is a **primitive**, not a step you schedule: the single source of truth for the interview technique, kept in one place so every skill that needs an interview reaches for it instead of inventing one. [matt-grill-me](matt-grill-me.md) and [matt-grill-with-docs](../engineering/matt-grill-with-docs.md) are its two user-invoked front doors, and `matt-grill-with-docs` is where the main build chain begins, ahead of [matt-to-spec](../engineering/matt-to-spec.md). [matt-wayfinder](../engineering/matt-wayfinder.md) runs it to resolve decision tickets, [triage](../engineering/matt-triage.md) to grill a vague report into a workable one, and [matt-improve-codebase-architecture](../engineering/matt-improve-codebase-architecture.md) to walk the tree once you have picked a candidate to deepen. When you are unsure which entry point fits, [matt-ask](../engineering/matt-ask-matt.md) routes you.
